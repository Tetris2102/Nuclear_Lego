...
int main() {
    XSTable myTable{};
    myTable.addRecord(ABSORB, BETA, NONE, 0, 6.2, 1.4);
    myTable.addRecord(SCATTER, BETA, BETA, 0, 20.0, 1.3);
    myTable.addRecord(REACTION, BETA, GAMMA, 0, 1.7, 1.7);
    Material Pb207("Pb207", 207, 13.0, myTable);
    Particle beta(BETA, 1.4, {0.5, 0.9, 0.05}, {0.0, 0.2, 0.9});
    cout << "Found cross-section: " << Pb207.getXS(ABSORB, beta) << " barns." << endl;
